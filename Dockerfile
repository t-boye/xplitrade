...
# Install dependencies
COPY --chown=ftuser:ftuser requirements.txt requirements-hyperopt.txt /xplitrade/
USER ftuser
...
USER ftuser
# Install and execute
COPY --chown=ftuser:ftuser . /xplitrade/

RUN pip install -e . --user --no-cache-dir \
  && mkdir /xplitrade/user_data/ \
