...
from xplitrade.config_schema.config_schema import (
    CONF_SCHEMA,
...
from xplitrade.configuration.deprecated_settings import process_deprecated_setting
from xplitrade.constants import UNLIMITED_STAKE_AMOUNT
from xplitrade.enums import RunMode, TradingMode
...
def _validate_edge(conf: dict[str, Any]) -> None:
    ...
    if conf.get("edge", {}).get("enabled"):
        raise ConfigurationError(
            "Edge is no longer supported and has been removed from Xplitrade with 2025.6."
        )
