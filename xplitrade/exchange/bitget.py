...
from xplitrade.enums import OPTIMIZE_MODES, CandleType, MarginMode, PriceType, TradingMode
...
from xplitrade.exchange.common import API_RETRY_COUNT, retrier
from xplitrade.exchange.exchange_types import CcxtOrder, FtHas
from xplitrade.util import dt_from_ts, dt_now, dt_ts
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES and self.margin_mode == MarginMode.ISOLATED:
            ...
            raise OperationalException(
                "Xplitrade currently only supports isolated futures for bitget"
            )
