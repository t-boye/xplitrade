...
from xplitrade.enums import TRADE_MODES, CandleType, MarginMode, PriceType, RunMode, TradingMode
from xplitrade.exceptions import DDosProtection, OperationalException, TemporaryError
from xplitrade.exchange import Exchange
from xplitrade.exchange.binance_public_data import (
    concat_safe,
    download_archive_ohlcv,
    download_archive_trades,
)
from xplitrade.exchange.common import retrier
from xplitrade.exchange.exchange_types import FtHas, Tickers
from xplitrade.exchange.exchange_utils_timeframe import timeframe_to_msecs
from xplitrade.misc import deep_merge_dicts, json_load
from xplitrade.util import FtTTLCache
from xplitrade.util.datetime_helpers import dt_from_ts, dt_ts
...
class Binance(Exchange):
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by xplitrade. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by xplitrade. "
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/Xplitrade/Xplitrade/pull/5779#discussion_r740175931
