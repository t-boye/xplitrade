...
from xplitrade.configuration.load_config import CONFIG_PARSE_MODE
from xplitrade.exceptions import OperationalException
from xplitrade.exchange.exchange_types import Tickers
from xplitrade.plugins.pairlist.IPairList import IPairList, PairlistParameter, SupportsBacktesting
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> tuple[list[str], float]:
        headers = {"User-Agent": "Xplitrade/" + __version__ + " Remotepairlist"}
