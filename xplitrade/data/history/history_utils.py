...
from xplitrade.data.history.datahandlers import IDataHandler, get_datahandler
...
from xplitrade.exchange.exchange_utils import date_minus_candles
...
def refresh_backtest_ohlcv_data(
    ...
    *,
    ...
    Used by xplitrade download-data subcommand.
