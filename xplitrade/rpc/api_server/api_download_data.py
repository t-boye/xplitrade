...
from xplitrade.rpc.api_server.api_pairlists import handleExchangePayload
from xplitrade.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from xplitrade.data.history.history_utils import download_data
