...
from xplitrade.enums import BacktestState, RunMode
from xplitrade.exceptions import ConfigurationError, DependencyException, OperationalException
from xplitrade.ft_types import get_BacktestResultType_default
from xplitrade.misc import deep_merge_dicts, is_file_in_dir
from xplitrade.rpc.api_server.api_schemas import (
...
from xplitrade.rpc.api_server.deps import get_config, verify_strategy
...
def __run_backtest_bg(btconfig: Config, job_id: str):
    ...
    from xplitrade.optimize.optimize_reports import generate_backtest_stats, store_backtest_results
...
def api_get_backtest():
    ...
    """
    from xplitrade.persistence import LocalTrade
