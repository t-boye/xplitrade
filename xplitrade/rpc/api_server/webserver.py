...
from xplitrade.configuration import running_in_docker
...
from xplitrade.rpc.api_server.ws.message_stream import MessageStream
from xplitrade.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def configure_app(self, app: FastAPI, config):
        from xplitrade.rpc.api_server.api_analysis import router_lookahead, router_recursive
        from xplitrade.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from xplitrade.rpc.api_server.api_background_tasks import router as api_bg_tasks
        from xplitrade.rpc.api_server.api_backtest import router as api_backtest
        from xplitrade.rpc.api_server.api_download_data import router as api_download_data
        from xplitrade.rpc.api_server.api_pair_history import router as api_pair_history
        from xplitrade.rpc.api_server.api_pairlists import router as api_pairlists
        from xplitrade.rpc.api_server.api_trading import router as api_trading
