...
from xplitrade.persistence import FtNoDBContext
...
from xplitrade.rpc.api_server.deps import get_config, get_exchange
...
def handleExchangePayload(payload: ExchangeModePayloadMixin, config_loc: Config):
    ...
    """
    from xplitrade.configuration.directory_operations import create_datadir
