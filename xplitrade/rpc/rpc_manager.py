...
from xplitrade.enums import NO_ECHO_MESSAGES, RPCMessageType
from xplitrade.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, xplitrade) -> None:
        ...
        self._rpc = RPC(xplitrade)
        config = xplitrade.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from xplitrade.rpc.telegram import Telegram
