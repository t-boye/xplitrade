...
from xplitrade.constants import DUST_PER_COIN, Config
from xplitrade.enums import MarketDirection, RPCMessageType, SignalDirection, TradingMode
from xplitrade.exceptions import OperationalException
from xplitrade.misc import chunks, plural
from xplitrade.persistence import Trade
from xplitrade.rpc import RPC, RPCException, RPCHandler
from xplitrade.rpc.rpc_types import RPCEntryMsg, RPCExitMsg, RPCOrderMsg, RPCSendMsg
...
class Telegram(RPCHandler):
    ...
    def _add_analyzed_candle(self, pair: str) -> str:
        ...
        if candle_val != "off" and candle_val == "ohlc":
            analyzed_df, _ = self._rpc._Xplitrade.dataprovider.get_analyzed_dataframe(
    ...
    async def _help(self, update: Update, context: CallbackContext) -> None:
        ...
        if self._rpc._Xplitrade.trading_mode != TradingMode.SPOT:
            force_enter_text += (
    ...
    async def _version(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        strategy_version = self._rpc._Xplitrade.strategy.version()
    ...
    async def _show_config(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        val = RPC._rpc_show_config(self._config, self._rpc._Xplitrade.state)
