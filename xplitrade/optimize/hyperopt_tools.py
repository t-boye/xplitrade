...
from xplitrade.constants import FTHYPT_FILEVERSION, HYPEROPT_BUILTIN_SPACES, Config
from xplitrade.enums import HyperoptState
from xplitrade.exceptions import OperationalException
from xplitrade.misc import deep_merge_dicts, round_dict, safe_value_fallback2
from xplitrade.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get("is_best") is None:
                raise OperationalException(
                    ...
                    "of Xplitrade and cannot be loaded."
                )
