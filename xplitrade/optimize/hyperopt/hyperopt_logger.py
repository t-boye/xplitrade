...
from xplitrade.loggers import get_existing_handlers
...
def logging_mp_setup(log_queue: Queue, verbosity: int):
    ...
    if current_proc != "MainProcess":
        ...
        # Disable xplitrade logging outside of the main process
        # This only leaves logging from the strategy (unless it's prefixed with "xplitrade.")
        # and eventually from other libraries.
        if verbosity > logging.DEBUG:
            logging.getLogger("xplitrade").setLevel(logging.WARNING)
