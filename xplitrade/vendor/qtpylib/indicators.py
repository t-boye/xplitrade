# xplitrade previously vendored a copy of qtpylib's indicators
...
# `from xplitrade.vendor.qtpylib.indicators import crossed_above` keep working,
...
warnings.warn(
    "'xplitrade.vendor.qtpylib.indicators' is deprecated and will be removed in a future "
