...
from xplitrade.configuration import remove_exchange_credentials, validate_config_consistency
from xplitrade.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from xplitrade.data.converter import count_total_order_book
...
from xplitrade.exchange.exchange_types import CcxtOrder
from xplitrade.leverage.liquidation_price import update_liquidation_prices
from xplitrade.misc import safe_value_fallback, safe_value_fallback2
from xplitrade.mixins import LoggingMixin
from xplitrade.persistence import Order, PairLocks, Trade, init_db
...
from xplitrade.rpc import RPCManager
from xplitrade.rpc.external_message_consumer import ExternalMessageConsumer
from xplitrade.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from xplitrade.util import FtPrecise, FtScheduler, MeasureTime, PeriodicCache, dt_from_ts, dt_now
from xplitrade.util.migrations import migrate_live_content
...
class XplitradeBot(LoggingMixin):
    ...
    def process(self) -> None:
        ...
        # Without this, xplitrade may try to recreate stoploss_on_exchange orders
