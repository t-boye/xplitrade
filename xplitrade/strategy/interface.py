...
from xplitrade.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from xplitrade.data.converter import populate_dataframe_with_trades
from xplitrade.data.converter.converter import reduce_dataframe_footprint
...
from xplitrade.exceptions import OperationalException, StrategyError
from xplitrade.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from xplitrade.ft_types import AnnotationType
from xplitrade.misc import remove_entry_exit_signals
from xplitrade.persistence import Order, PairLocks, Trade
from xplitrade.strategy.hyper import HyperStrategyMixin
from xplitrade.strategy.informative_decorator import (
    InformativeCache,
    InformativeData,
    PopulateIndicators,
...
from xplitrade.strategy.strategy_validation import StrategyResultValidator
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for xplitrade strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from xplitrade.freqai.utils import download_all_data_for_training
            from xplitrade.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by xplitrade itself, but intended to be used if users lock pairs
    ...
    def ft_plot_annotations(self, pair: str, dataframe: DataFrame) -> list[AnnotationType]:
        ...
        if len(dataframe) > 0:
            ...
            from xplitrade.ft_types.plot_annotation_type import AnnotationTypeTA
