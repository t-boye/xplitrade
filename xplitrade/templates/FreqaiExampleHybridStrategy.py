...
from xplitrade.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    xplitrade trade --strategy FreqaiExampleHybridStrategy --strategy-path xplitrade/templates
