...
import xplitrade.exchange as exchanges
from xplitrade.constants import Config, ExchangeConfig
from xplitrade.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in xplitrade.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("xplitrade.", ""),
                    }
                )
        return result
