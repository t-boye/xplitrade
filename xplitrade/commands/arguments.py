...
from xplitrade.commands.cli_options import AVAILABLE_CLI_OPTIONS
from xplitrade.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="xplitrade", description="Free, open source crypto trading bot"
        )
        ...
        edge_cmd = subparsers.add_parser(
            "edge",
            # help="Edge module. No longer part of Xplitrade",
