...
from xplitrade.constants import DATETIME_PRINT_FORMAT, DL_DATA_TIMEFRAMES, Config
from xplitrade.enums import CandleType, RunMode, TradingMode
from xplitrade.exceptions import ConfigurationError
...
def start_download_data(args: dict[str, Any]) -> None:
    ...
    from xplitrade.data.history import download_data_main
...
def start_convert_trades(args: dict[str, Any]) -> None:
    from xplitrade.configuration import TimeRange, setup_utils_configuration
    from xplitrade.data.converter import convert_trades_to_ohlcv
...
def start_convert_data(args: dict[str, Any], ohlcv: bool = True) -> None:
    ...
    """
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.data.converter import convert_ohlcv_format, convert_trades_format
...
def start_list_trades_data(args: dict[str, Any]) -> None:
    ...
    """
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.misc import plural
    from xplitrade.util import print_rich_table
