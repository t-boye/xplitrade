...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from xplitrade.exchange import list_available_exchanges
    from xplitrade.ft_types import ValidExchangesType
    from xplitrade.loggers.rich_console import get_rich_console
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for Xplitrade ({len(available_exchanges)} exchanges):"
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.exchange import market_is_active
    from xplitrade.misc import plural, safe_value_fallback
    from xplitrade.resolvers import ExchangeResolver
    from xplitrade.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.misc import parse_db_uri_for_logging
