...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from xplitrade.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting xplitrade in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from xplitrade.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting xplitrade in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of xplitrade Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help xplitrade to exit
...
def start_lookahead_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from xplitrade.configuration import setup_utils_configuration
    from xplitrade.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
