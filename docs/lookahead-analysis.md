...
The reason why strategies can "cheat" is because the xplitrade backtesting process populates the full dataframe including all candle timestamps at the outset.
