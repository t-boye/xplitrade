...
You can analyze the results of backtests and trading history easily using Jupyter notebooks. Sample notebooks are located at `user_data/notebooks/` after initializing the user directory with `xplitrade create-userdir --userdir user_data`.
...
* Copy the example notebook before use so your changes don't get overwritten with the next xplitrade update.
...
This prevents you from installing the full jupyter suite multiple times per system, and provides an easy way to switch between tasks (xplitrade / other analytics tasks).
...
ipython kernel install --user --name=xplitrade
# Restart jupyter (lab / notebook)
# select kernel "xplitrade" in the notebook
```

!!! Note
    This section is provided for completeness, the Xplitrade Team won't provide full support for problems with this setup and will recommend to install Jupyter in the virtual environment directly, as that is the easiest way to get jupyter notebooks up and running. For help with this setup please refer to the [Project Jupyter](https://jupyter.org/) [documentation](https://jupyter.org/documentation) or [help channels](https://jupyter.org/community).
