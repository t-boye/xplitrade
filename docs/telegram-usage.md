...
Choose the public name of your bot (e.x. `Xplitrade bot`)
...
To get the group ID, you can add the bot to the group, start xplitrade, and issue a `/tg_info` command.
...
For the Xplitrade configuration, you can then use the full value (including `-` ) as string:
...
!!! Warning "Using telegram groups"
    When using telegram groups, you're giving every member of the telegram group access to your xplitrade bot and to all commands possible via telegram. Please make sure that you can trust everyone in the telegram group to avoid unpleasant surprises.
...
Xplitrade provides means to control the verbosity of your telegram bot.
