...
from xplitrade_client import __version__
from xplitrade_client.ft_rest_client import FtRestClient
...
def add_arguments(args: Any = None):
    parser = argparse.ArgumentParser(
        prog="xplitrade-client",
        description="Client for the xplitrade REST API",
    )
    parser.add_argument(
