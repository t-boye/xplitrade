...
def test_crossed_numpy_types():
    ...
    # xplitrade.vendor.qtpylib is a deprecated shim around technical and emits a
...
def test_qtpylib_deprecation():
    ...
    with pytest.warns(FutureWarning, match="xplitrade.vendor.qtpylib.indicators' is deprecated"):
