...
from xplitrade.commands.optimize_commands import setup_optimize_configuration
...
def test_freqai_backtest_start_backtest_list(freqai_conf, mocker, testdatadir, caplog):
    ...
    mocker.patch("xplitrade.optimize.backtesting.history.load_data")
    mocker.patch("xplitrade.optimize.backtesting.history.get_timerange", return_value=(now, now))
...
def test_freqai_backtest_consistent_timerange(mocker, freqai_conf):
    ...
    gbs = mocker.patch("xplitrade.optimize.backtesting.generate_backtest_stats")
