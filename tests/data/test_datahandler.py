...
from xplitrade.candle_columns import get_candle_columns
from xplitrade.configuration import TimeRange
from xplitrade.constants import AVAILABLE_DATAHANDLERS, DEFAULT_DATAFRAME_COLUMNS
from xplitrade.data.converter import ohlcv_to_dataframe
from xplitrade.data.history.datahandlers.featherdatahandler import FeatherDataHandler
from xplitrade.data.history.datahandlers.idatahandler import (
    IDataHandler,
    get_datahandler,
    get_datahandlerclass,
)
from xplitrade.data.history.datahandlers.jsondatahandler import JsonDataHandler, JsonGzDataHandler
from xplitrade.data.history.datahandlers.parquetdatahandler import ParquetDataHandler
...
def test_generic_datahandler_ohlcv_load_and_resave(
    ...
    mocker.patch(
        "xplitrade.data.history.datahandlers.arrowdatahandler.dataset.dataset",
        side_effect=ValueError("Test"),
    )
    mocker.patch(
        "xplitrade.data.history.datahandlers.featherdatahandler.read_feather",
        side_effect=Exception("Test"),
    )
    mocker.patch(
        "xplitrade.data.history.datahandlers.parquetdatahandler.read_parquet",
        side_effect=Exception("Test"),
    )
