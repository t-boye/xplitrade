...
from xplitrade.constants import DEFAULT_TRADES_COLUMNS
from xplitrade.data.converter import populate_dataframe_with_trades
from xplitrade.data.converter.orderflow import (
    ORDERFLOW_ADDED_COLUMNS,
    stacked_imbalance,
    timeframe_to_DateOffset,
    trades_to_volumeprofile_with_total_delta_bid_ask,
)
from xplitrade.data.converter.trade_converter import trades_list_to_df
...
def test_analyze_with_orderflow(
    ...
    import xplitrade.data.converter.orderflow as orderflow_module
