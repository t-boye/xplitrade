...
from xplitrade.persistence import KeyValueStore, Order, Trade, WalletHistory
from xplitrade.util import dt_now, dt_utc
from xplitrade.util.migrations.migrate_wallet_history import (
...
def test_migrate_wallet_history_skips_when_no_ohlcv_history(mocker, default_conf_usdt):
    ...
    migrate_mock = mocker.patch(
        "xplitrade.util.migrations.migrate_wallet_history._migrate_wallet_history"
    )
