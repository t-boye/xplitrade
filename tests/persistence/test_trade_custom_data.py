...
from xplitrade.data.history.history_utils import get_timerange
from xplitrade.optimize.backtesting import Backtesting
from xplitrade.persistence import Trade, disable_database_use, enable_database_use
...
def test_trade_custom_data_strategy_compat(mocker, default_conf_usdt, fee):
    ...
    mocker.patch("xplitrade.xplitradebot.XplitradeBot.get_real_amount", return_value=None)
    mocker.patch("xplitrade.xplitradebot.XplitradeBot.handle_cancel_exit", return_value=True)
    ...
    xplitrade.strategy.custom_exit = custom_exit
    ff_spy = mocker.spy(xplitrade.strategy, "custom_exit")
