...
from xplitrade.constants import CUSTOM_TAG_MAX_LENGTH, DATETIME_PRINT_FORMAT
from xplitrade.enums import TradingMode
from xplitrade.exceptions import DependencyException
from xplitrade.exchange.exchange_utils import TICK_SIZE
...
def test_update_order_from_ccxt(caplog, time_machine):
    ...
    # https://github.com/Xplitrade/Xplitrade/issues/5404
...
def test_recalc_trade_from_orders_kucoin():
    # Taken from https://github.com/Xplitrade/Xplitrade/issues/9346
