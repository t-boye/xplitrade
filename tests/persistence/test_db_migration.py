...
from xplitrade.persistence.key_value_store import _KeyValueStoreModel
from xplitrade.persistence.pairlock import PairLock
from xplitrade.persistence.trade_model import Trade
...
def test_migrate_db_detail(mocker):
    ...
    make_transient_mock = mocker.patch("xplitrade.persistence.db_migration.make_transient")
    set_sequence_ids_mock = mocker.patch("xplitrade.persistence.db_migration.set_sequence_ids")
