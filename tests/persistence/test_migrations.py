...
from xplitrade.constants import DEFAULT_DB_PROD_URL
...
from xplitrade.persistence.base import ModelBase
from xplitrade.persistence.migrations import get_last_sequence_ids, set_sequence_ids
...
def test_init_prod_db(default_conf, mocker):
    ...
    create_engine_mock = mocker.patch("xplitrade.persistence.models.create_engine", MagicMock())
...
def test_migrate(mocker, default_conf, fee, caplog):
    ...
    mocker.patch("xplitrade.persistence.models.create_engine", lambda *args, **kwargs: engine)
