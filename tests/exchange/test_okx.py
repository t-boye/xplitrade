...
from xplitrade.enums import CandleType, MarginMode, TradingMode
from xplitrade.exceptions import RetryableOrderError, TemporaryError
from xplitrade.exchange.common import API_RETRY_COUNT
from xplitrade.exchange.exchange import timeframe_to_minutes
...
def test_load_leverage_tiers_okx(default_conf, mocker, markets, tmp_path, caplog, time_machine):
    ...
    # fd_mock = mocker.patch('xplitrade.exchange.exchange.file_dump_json')
    api_mock = MagicMock()
